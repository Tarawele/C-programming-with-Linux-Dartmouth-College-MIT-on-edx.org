...
//      via the input parameter to the function and the null terminator and
//      store the address of the allocated memory in a pointer named ptr. In
//      order to receive credit for your solution you need to use sizeof(char)
...
int main(void) {
  ...
  /* This time the goal is to reserve space in memory for the dark setting
     label. Store the return value of the function call in the variable
     strDark.
   */
